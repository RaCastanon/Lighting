...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        OpenImageButton->setGeometry(QRect(20, 20, 81, 31));
        closeApp = new QPushButton(centralWidget);
        closeApp->setObjectName(QStringLiteral("closeApp"));
        closeApp->setGeometry(QRect(264, 212, 101, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        closeApp->setText(QApplication::translate("MainWindow", "Close Application", 0));
    } // retranslateUi
